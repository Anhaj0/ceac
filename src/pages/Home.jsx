...
// --- TESTIMONIAL DATA (Removed Mr. Tariq Khan) ---
const testimonials = [
  {
    id: 1,
    name: "Amra Iynas (PET)",
  ...
  },
  {
    ...
    name: "M.N.F. Hazeena",
    title: "Student",
    text: "Ms. Raeesha is the heart and soul of CEAC. Her class was a safe heaven where we could express ourselves freely. She encouraged me to read, write my first novel, and even land my first job as a librarian."
  }
];
    ...
    <div className="relative w-full overflow-hidden py-8">
      ...
      >
        {testimonials.map((t) => (
          ...
          >
            {/* Cards with only Text and Name (No images) */}
            <div className="bg-white p-8 rounded-xl shadow-lg h-full flex flex-col items-center text-center border-t-4 border-brand-gold relative">
              ...
              <div className="mt-auto flex flex-col items-center">
                {/* Removed the Image div completely */}
        ...
        {testimonials.map((_, idx) => {
          ...
          return (
            <button
              ...
              className={`h-3 w-3 rounded-full transition-all duration-300 ${idx === currentIndex ? 'bg-brand-blue w-6' : 'bg-gray-300 hover:bg-brand-gold'
                }`}
  ...
  return (
    <div className="page-content space-y-20">
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 bg-blue-50 rounded-xl my-16">
        <SectionHeader title="What People Say" subtitle="Words from our Students and Parents." />
        <FeedbackCarousel />
      </section>
