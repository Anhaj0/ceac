...
export default function Timetable() {
  ...
  const schedule = [
    { 
      ...
      times: [
        // Changed to 4-6
        { time: "4:00 - 6:00 p.m.", class: "Flyers Group 1" }
      ] 
    },
    { 
      day: "Tuesdays", 
      times: [
        // Changed to 4-6
        { time: "4:00 - 6:00 p.m.", class: "Movers Group 1" }
      ] 
    },
    { 
      day: "Wednesdays", 
      times: [
        ...
        // Changed to 4-6
        { time: "4:00 - 6:00 p.m.", class: "Beginners" }
      ] 
    },
    { 
      day: "Thursdays", 
      times: [
        // Renamed KET -> A2 for Ladies, Morning time stays same
        { time: "9:15 - 11:15 a.m.", class: "A2 for Ladies" },
        // Changed to 4-6
        { time: "4:00 - 6:00 p.m.", class: "Jolly Phonics" }
      ] 
    },
    { 
      day: "Fridays", 
      times: [
        // Changed to 4-6
        { time: "4:00 - 6:00 p.m.", class: "Starters Group 1" }
      ] 
    },
    { 
      day: "Saturdays", 
  ...
  return (
    <section id="timetable" className="page-content">
       {/* Blue Header */}
      <h2 className="text-4xl font-bold text-center mb-10 text-brand-blue">Class Timetables (From December)</h2>
